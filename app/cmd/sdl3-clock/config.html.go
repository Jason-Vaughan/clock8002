            ...
            <div class="tab-content">
              ...
              <fieldset>
                ...
                <fieldset>
                  ...
                  {{float "TextClockScale" "Scale for text clock timers, icons and signal dots. 1.0 fills the row, lower values shrink the timers in place. Labels are not affected." 0.5 1.0 0.05 .TextClockScale}}
                </fieldset>
              </fieldset>
            </div>
          </div>
